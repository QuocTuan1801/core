            ...
            <div class="row">
                <div class="col-sm-12">
                    <nav class="woocommerce-breadcrumb">
                        ...
                        <span class="separator">/</span> Shop list
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-3 sidebar-shop">
                    <div class="sidebar-product-categori">
                            ...
                            <div class="widget-content">
                                <ul class="product_list_widget">
                                    <li class="widget-mini-product">
                                        <div class="product-image">
                                            <a title="Phasellus vel hendrerit" href="#">
                                                <img alt="" src="<?= BASE_URL ?>main/images/product/2.jpg">
                                            </a>
                                        </div>
                                    ...
                                    <li class="widget-mini-product">
                                        <div class="product-image">
                                            <a title="Phasellus vel hendrerit" href="#">
                                                <img alt="" src="<?= BASE_URL ?>main/images/product/3.jpg">
                                            </a>
                                        </div>
                                        <div class="product-info">
                                            <a title="Phasellus vel hendrerit" href="#">
                        ...
                        <div class="sidebar-single-banner">
                            <a href="#">
                                <img src="<?= BASE_URL ?>main/images/banner/shop-sidebar.jpg" alt="Banner">
                            </a>
                        </div>
                ...
                <div class="col-xs-12 col-md-9 shop-content">
                    <div class="shop-banner">
                        <img src="<?= BASE_URL ?>main/images/banner/shop-category.jpg" alt="">
                    </div>
